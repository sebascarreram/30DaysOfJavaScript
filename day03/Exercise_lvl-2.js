...
const messageLeap1 = `Year ${myYear1} ${
	myYear1 === yearsNow ? "is" : "was"
} a leap year`;
const messageLeap2 = `Year ${myYear1} ${
	myYear1 === yearsNow ? "is not" : "was not"
} a leap year`;

const isLeap = `${
	parseInt(myYear1 / 4) === myYear1 / 4 ? messageLeap1 : messageLeap2
}`;
console.log(isLeap);

//
console.log(
	`${myAge1} years / ${monthsNow - myMonth} months / ${daysNow - myDay} days`
);
